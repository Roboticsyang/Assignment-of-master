// TextureMaping2.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
void display(void)
{
	...
	gluPerspective(75, 1, 1, 21);//创建一个投影矩阵并且与当前矩阵相乘
...
int main(int argc, char* argv[])
{
	...
	texGround = load_texture("Data/Grass.bmp");  //加载纹理
	texWall = load_texture("Data/Wood.bmp");
	texBrick = load_texture("Data/Brick.bmp");
